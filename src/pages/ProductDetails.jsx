        ...
        <div className="productDetails">
          ...
          <div className="firstPart">
            <div className="leftPart">
              ...
              <div className="tags">{renderInfo(product.info)}</div>
            </div>
              ...
              <div className="centerPart">
                ...
                <Accordion>
                  ...
                  <Accordion.Item eventKey="3">
                    <Accordion.Header>
                      <h5>Dikkat Edilmesi Gereken Noktalar</h5>
                    </Accordion.Header>
                    <Accordion.Body>
                      <p>
                      {renderConsumption(product.consumption)}
                      </p>
                    </Accordion.Body>
                  </Accordion.Item>
